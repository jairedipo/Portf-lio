...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	parametros := mux.Vars(r) // Obtém os parâmetros enviados na URL

	ID, erro := strconv.ParseUint(parametros["id"], 10, 32) // Parâmetro, base, tipo(int32)
	if erro != nil {
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao connverter o parâmetro para inteiro"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if _, erro := statement.Exec(ID); erro != nil {
		w.Write([]byte("Erro deletar o usuário"))
		return
	}
